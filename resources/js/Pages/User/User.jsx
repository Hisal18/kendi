                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <button
                                    ...
                                    className="group bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 dark:from-blue-400 dark:to-indigo-500 dark:hover:from-blue-500 dark:hover:to-indigo-600 text-white font-medium py-2.5 px-5 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg flex items-center space-x-2 hover:ring-2 hover:ring-blue-400 dark:hover:ring-blue-300"
                                >
                                ...
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                        <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="text-sm text-gray-900 dark:text-gray-100">john@example.com</div>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
